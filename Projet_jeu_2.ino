...
enum eEtatDel {VERT, JAUNE, BLEUE, ROUGE, NOIR, BLANC, BLEUECIEL, MAUVE};
/*
void machine_a_etat_Lumiere_DEL1(){
  static eEtatDel etat = VERT;


 switch(etat){
case VERT: // Etat feux vert
      DelR2_OFF(0);
      DelV2_ON(1);
      DelB2_OFF(0);
...
default: // Etat invalide, retour a etat Vert par defaut\
      etat = VERT;
    break;
 }
*/
